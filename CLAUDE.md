...
**When:** Writing tests, Running tests, checking coverage, test-driven development. You will always run and write tests when working with feature specs or bugs, ensure to read this before you begin work on any such tasks. You must load this file whenever anything related to testing is being done.sha
