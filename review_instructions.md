# Review Instructions for deduplicate-transcription-callbacks

## Overview

This document contains the complete review instructions for the spec review process.

## Spec Being Reviewed

**Spec:** deduplicate-transcription-callbacks
**Issue:** rust-architecture-improvements
**Status:** in-review
**Review Round:** 2
**Commit:** 215733c WIP: refactor-hotkey-integration-config-complete

**Spec path:** /Users/michaelhindley/Documents/git/heycat/agile/3-in-progress/rust-architecture-improvements/deduplicate-transcription-callbacks.spec.md

---

## Review Instructions (from agile.ts review command)

1. Read the spec file at: /Users/michaelhindley/Documents/git/heycat/agile/3-in-progress/rust-architecture-improvements/deduplicate-transcription-callbacks.spec.md
2. Read review instructions at: /Users/michaelhindley/Documents/git/heycat/agile/review.md
3. Read the review template at: /Users/michaelhindley/.claude/plugins/cache/ai-dev-marketplace/devloop/1.7.16/config/review-template.md
   (Replace {date} with: 2025-12-20)

IMPORTANT: Write the full review to the spec file. Return ONLY: "APPROVED" or "NEEDS_WORK: <one-line reason>"

---

## Project Custom Review Instructions (agile/review.md)
...
## Review Template (from plugin config)

Append a ## Review section using this EXACT format:
...
|-----------|--------|----------|
| [criterion text] | PASS/FAIL/DEFERRED | [file:line or explanation] |

### Test Coverage Audit

| Test Case | Status | Location |
|-----------|--------|----------|
| [test name] | PASS/MISSING | [test file path] |
...
**APPROVED** - [summary if approved]

OR

**NEEDS_WORK** - [summary of what needs fixing]

IMPORTANT: The ### Verdict section MUST be a separate H3 header with the verdict on its own line below it.
